# Phase 1 OpenTofu configuration.
#
# Each phase has its own directory and state file. This means:
# - `tofu apply` in phase1/ only affects Phase 1 resources
# - `tofu destroy` in phase1/ won't touch other phases
